      ...
      <div class="container p-5 bg-white my-4">
        ...
        <div class="row">
          <div class="col ">
            ...
            <p class="mb-5 ">
              Por favor, verifique o seu pedido de táxi;
            </p>
          </div>
        </div>
        <div class="row">
            ...
            <div class="row justify-content-center">
                <div>
                    <div>
                        ...
                        <p class='d-inline-block fw-bold'><?=$order->street_start?></p>
                    </div>

                    <div >
                        <p class="d-inline-block">CEP / CIDADE:</p>
                        <p class="d-inline-block fw-bold"><?=$order->cep_start?> / <?=$order->city_start?></p>
                    </div>

                    <div>
                        <h3>Endereco de Destino</h3>
                        <p class='d-inline-block'>Rua:</p>
                        <p class='d-inline-block fw-bold'><?=$order->street_end?></p>
                    </div>

                    <div >
                        <p class="d-inline-block">CEP / CIDADE:</p>
                        <p class="d-inline-block fw-bold"><?=$order->cep_end?> / <?=$order->city_end?></p>
                    </div>
